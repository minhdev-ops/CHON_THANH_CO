  ...
  <div>
    ...
    <section class="py-10 md:py-20 bg-surface-bright relative mesh-bg">
      ...
      <div class="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 lg:gap-24 items-start">
            ...
            <div class="relative ml-4 md:ml-0">
              ...
              <div class="space-y-4 md:space-y-6 py-4">
                <div v-for="(item, i) in timeline" :key="i" class="relative pl-12 reveal" :class="`reveal-delay-${(i % 6) + 1}`">
                  ...
                  <div class="bg-surface-bright border border-outline-variant rounded-2xl p-4 md:p-7 hover:shadow-[0_12px_40px_rgba(184,155,136,0.12)] hover:border-[#B89B88] transition-all duration-500 group card-shine">
                    <div class="flex items-center gap-3 mb-2 md:mb-3">
                      <span class="text-[12px] md:text-[13px] font-bold text-primary bg-primary/8 px-3 py-1 rounded-full uppercase tracking-wider">{{ item.year }}</span>
                    </div>
                    <p class="text-[13px] md:text-[15px] text-text-secondary leading-relaxed">{{ item.description }}</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <!-- Mission & Vision -->
    <section class="py-10 md:py-24 relative overflow-hidden mesh-bg">
      ...
      <div class="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 lg:gap-12">
          <div class="bg-surface-bright p-6 md:p-12 border border-outline-variant shadow-sm rounded-2xl md:rounded-3xl hover:shadow-[0_20px_60px_rgba(184,155,136,0.15)] hover:border-[#B89B88] transition-all duration-500 relative overflow-hidden group reveal-left glow-card">
            ...
            <div class="relative z-10">
              <div class="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-gradient-to-br from-[#B89B88]/15 to-[#B89B88]/5 flex items-center justify-center mb-4 md:mb-7 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
                <span class="material-symbols-outlined text-2xl md:text-3xl text-primary" style="font-variation-settings: 'FILL' 1;">flag</span>
              </div>
              <h2 class="text-[22px] md:text-[32px] text-text-main font-bold mb-3 md:mb-5 tracking-tight">{{ t('about.mission') }}</h2>
              <p class="text-text-secondary leading-[1.8] text-[14px] md:text-[17px]">{{ missionText }}</p>
            </div>
          </div>

          <div class="bg-surface-bright p-6 md:p-12 border border-outline-variant shadow-sm rounded-2xl md:rounded-3xl hover:shadow-[0_20px_60px_rgba(140,107,88,0.15)] hover:border-[#8C6B58] transition-all duration-500 relative overflow-hidden group reveal-right glow-card">
            ...
            <div class="relative z-10">
              <div class="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-gradient-to-br from-[#8C6B58]/15 to-[#8C6B58]/5 flex items-center justify-center mb-4 md:mb-7 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
                <span class="material-symbols-outlined text-2xl md:text-3xl text-[#8C6B58]" style="font-variation-settings: 'FILL' 1;">visibility</span>
              </div>
              <h2 class="text-[22px] md:text-[32px] text-text-main font-bold mb-3 md:mb-5 tracking-tight">{{ t('about.vision') }}</h2>
              <p class="text-text-secondary leading-[1.8] text-[14px] md:text-[17px]">{{ visionText }}</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Core Values -->
    <section class="py-10 md:py-24 bg-canvas">
      <div class="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop">
        ...
        <div class="hidden md:grid grid-cols-2 lg:grid-cols-4 gap-6 stagger-grid">
        ...
        <div class="flex flex-col gap-2 md:hidden">
          <div v-for="(v, i) in coreValues" :key="i"
            class="flex items-center gap-3 bg-surface-bright border border-outline-variant rounded-2xl p-4 shadow-sm transition-all duration-300 group">
            <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-primary/15 to-primary/5 flex items-center justify-center shrink-0 group-hover:scale-110 transition-all duration-500">
              <span class="material-symbols-outlined text-[20px] text-primary-deep" style="font-variation-settings: 'FILL' 1;">{{ v.icon }}</span>
            </div>
            <div class="flex-1 min-w-0">
              <h3 class="font-extrabold text-text-main text-[14px] tracking-tight">{{ v.title }}</h3>
              <p class="text-text-secondary text-[12px] leading-snug line-clamp-2 mt-0.5">{{ v.desc }}</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Stats / Milestones -->
    <section class="py-10 md:py-24 bg-surface-bright relative overflow-hidden">
      ...
      <div class="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop text-center relative z-10">
        <div class="text-center mb-8 md:mb-16 reveal">
          ...
          <h2 class="text-[26px] md:text-[42px] text-text-main font-bold tracking-tight">Năng lực của chúng tôi</h2>
        </div>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 mb-8 md:mb-10 text-left stagger-grid">
          <div v-for="(m, i) in milestones" :key="i"
            class="bg-surface-bright rounded-2xl p-4 md:p-6 shadow-sm border border-outline-variant hover:shadow-xl hover:border-primary/30 transition-all duration-500 group card-shine">
            <div class="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-primary/10 flex items-center justify-center mb-3 md:mb-4 group-hover:bg-primary group-hover:text-white transition-all duration-500">
    ...
    <!-- Two Factories -->
    <section class="py-10 md:py-24 bg-canvas relative overflow-hidden">
      <div class="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop">
        <div class="text-center max-w-2xl mx-auto mb-8 md:mb-14 reveal">
          <SectionHeader align="center" kicker="Nhà máy sản xuất" title="Hệ thống 2 nhà máy trên toàn quốc" />
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 stagger-grid">
          <div class="bg-surface-bright border border-outline-variant rounded-2xl md:rounded-3xl overflow-hidden shadow-sm hover:shadow-[0_20px_60px_rgba(184,155,136,0.15)] hover:border-primary/30 transition-all duration-500 group card-shine">
            <!-- Mobile: compact horizontal -->
            <div class="flex md:hidden items-center gap-3 p-4">
              ...
              <div class="flex-1 min-w-0">
                <h3 class="font-extrabold text-text-main text-[15px] leading-tight">Nhà máy Rọ đá Á Châu</h3>
                <span class="text-text-muted text-[11px] font-bold uppercase tracking-wider">Hóc Môn, TP.HCM</span>
                <p class="text-text-secondary text-[12px] leading-snug mt-1 line-clamp-2">Rọ đá, lưới B40, dây kẽm gai. 3.000 tấn/năm.</p>
              </div>
            </div>
            <!-- Desktop: full card -->
          ...
          <div class="bg-surface-bright border border-outline-variant rounded-2xl md:rounded-3xl overflow-hidden shadow-sm hover:shadow-[0_20px_60px_rgba(184,155,136,0.15)] hover:border-primary/30 transition-all duration-500 group card-shine">
            ...
            <div class="flex md:hidden items-center gap-3 p-4">
              ...
              <div class="flex-1 min-w-0">
                <h3 class="font-extrabold text-text-main text-[15px] leading-tight">Nhà máy Lưới thép Tiên Phong</h3>
                <span class="text-text-muted text-[11px] font-bold uppercase tracking-wider">Đà Nẵng</span>
                <p class="text-text-secondary text-[12px] leading-snug mt-1 line-clamp-2">Vải KT không dệt, vải dệt, lưới KT polyester. 5.000 tấn/năm.</p>
              </div>
            </div>
            <!-- Desktop: full card -->
            <div class="hidden md:block">
    ...
    <section class="py-10 md:py-24 relative overflow-hidden mesh-bg">
      ...
      <div class="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop text-center relative z-10">
        <div class="text-center mb-8 md:mb-16 reveal">
          ...
          <h2 class="text-[26px] md:text-[42px] text-text-main font-bold tracking-tight">Chứng nhận chất lượng</h2>
        </div>
        ...
        <div v-else class="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 stagger-grid">
          <router-link v-for="(cert, i) in certificates?.data ?? []" :key="cert.slug" to="/certificates"
            class="aspect-[3/4] bg-surface-bright border border-outline-variant p-3 md:p-6 flex flex-col items-center justify-center hover:shadow-[0_16px_48px_rgba(184,155,136,0.15)] hover:border-[#B89B88] transition-all duration-500 rounded-xl md:rounded-2xl group card-shine">
            <div class="w-full h-3/5 mb-2 md:mb-4 flex items-center justify-center group-hover:scale-110 transition-transform duration-500">
              <LazyImage
                :src="cert.image"
                :alt="cert.name"
            ...
            <span class="text-[11px] md:text-[13px] font-bold text-text-secondary text-center group-hover:text-primary transition-colors duration-300 leading-snug">{{ cert.name }}</span>
          </router-link>
        </div>
      </div>
    </section>
    ...
    <section class="py-10 md:py-24 bg-surface-bright">
      <div class="max-w-3xl mx-auto px-[var(--spacing-margin-mobile)] md:px-[var(--spacing-margin-desktop)] text-center reveal">
        <div class="border border-outline-variant p-8 md:p-16 bg-surface-bright shadow-md rounded-2xl md:rounded-3xl flex flex-col items-center hover:shadow-[0_20px_60px_rgba(184,155,136,0.15)] transition-all duration-500 relative overflow-hidden group">
          ...
          <div class="relative z-10">
            <div class="w-14 h-14 md:w-20 md:h-20 rounded-2xl bg-gradient-to-br from-[#B89B88]/15 to-[#B89B88]/5 flex items-center justify-center mb-5 md:mb-8 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
              <span class="material-symbols-outlined text-3xl md:text-4xl text-primary">picture_as_pdf</span>
            </div>
            <h2 class="text-[22px] md:text-[36px] text-text-main mb-4 md:mb-6 font-bold tracking-tight">{{ t('about.downloadProfile') }}</h2>
            <p class="text-text-secondary mb-6 md:mb-10 text-[14px] md:text-[17px] max-w-lg leading-relaxed">{{ t('about.downloadProfileText') }}</p>
            <router-link to="/contact" class="btn btn-magnetic bg-primary text-white hover:bg-primary-dark rounded-full py-3 md:py-4 px-8 md:px-10 text-[14px] md:text-[15px] inline-flex items-center gap-3 font-bold shadow-[0_4px_20px_rgba(184,155,136,0.3)] transition-all duration-500">
