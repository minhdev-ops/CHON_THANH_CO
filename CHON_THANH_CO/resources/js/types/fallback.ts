...
export const fallbackProducts: Product[] = [
  ...
  {
    slug: 'vai-kt-khong-det-art-14',
    code: 'ART 14',
    name: 'Vải địa kỹ thuật không dệt 14 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '14 kN/m',
    strength_min: '14.00',
    strength_max: '14.00',
    category: fallbackCategories[0],
    applications: [fallbackApplications[0], fallbackApplications[1]],
    description: 'Vải địa kỹ thuật không dệt 14 kN/m, dùng cho phân cách, lọc và thoát nước. Phù hợp gia cố nền đường, sân bay và khu công nghiệp. Đạt TCVN 9844:2013, ISO 9001:2015.',
    specs: [
      { icon: 'scale', label: 'Khối lượng đơn vị', value: '140 g/m² (±10%)' },
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '14 kN/m' },
      { icon: 'water_drop', label: 'Hệ số thấm', value: '≥ 1.5 × 10⁻³ m/s' },
    ],
  },
  {
    slug: 'vai-kt-khong-det-art-17',
    code: 'ART 17',
    name: 'Vải địa kỹ thuật không dệt 17 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '17 kN/m',
    strength_min: '17.00',
    strength_max: '17.00',
    category: fallbackCategories[0],
    applications: [fallbackApplications[0], fallbackApplications[1]],
    description: 'Vải địa kỹ thuật không dệt 17 kN/m, dùng cho phân cách, lọc và thoát nước. Phù hợp gia cố nền đường và khu công nghiệp. Đạt TCVN 9844:2013, ISO 9001:2015.',
    specs: [
      { icon: 'scale', label: 'Khối lượng đơn vị', value: '170 g/m² (±10%)' },
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '17 kN/m' },
      { icon: 'water_drop', label: 'Hệ số thấm', value: '≥ 1.5 × 10⁻³ m/s' },
    ],
  },
  {
    slug: 'vai-kt-khong-det-art-20',
    code: 'ART 20',
    name: 'Vải địa kỹ thuật không dệt 20 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '20 kN/m',
    strength_min: '20.00',
    strength_max: '20.00',
    category: fallbackCategories[0],
    applications: [fallbackApplications[2], fallbackApplications[1]],
    description: 'Vải địa kỹ thuật không dệt 20 kN/m, dùng cho gia cố nền, thoát nước. Phù hợp đường giao thông, sân bay và bãi chứa. Đạt TCVN 9844:2013, ISO 9001:2015.',
    specs: [
      { icon: 'scale', label: 'Khối lượng đơn vị', value: '200 g/m² (±10%)' },
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '20 kN/m' },
      { icon: 'water_drop', label: 'Hệ số thấm', value: '≥ 1.2 × 10⁻³ m/s' },
    ],
  },
  {
    slug: 'vai-kt-khong-det-art-24',
    code: 'ART 24',
    name: 'Vải địa kỹ thuật không dệt 24 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '24 kN/m',
    strength_min: '24.00',
    strength_max: '24.00',
    category: fallbackCategories[0],
    applications: [fallbackApplications[2], fallbackApplications[0]],
    description: 'Vải không dệt cường độ cao 24 kN/m, dùng cho gia cố nền đường, mái dốc, làm lớp phân cách dưới đáy móng, bảo vệ lớp chống thấm HDPE trong bãi rác. Sản phẩm đạt TCVN 9844:2013, ISO 9001:2015, tiêu chuẩn EN, ASTM.',
    specs: [
      { icon: 'scale', label: 'Khối lượng đơn vị', value: '240 g/m² (±10%)' },
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '24 kN/m' },
  ...
  {
    slug: 'vai-kt-khong-det-art-50',
    code: 'ART 50',
    name: 'Vải địa kỹ thuật không dệt 50 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '50 kN/m',
    strength_min: '50.00',
    strength_max: '50.00',
    category: fallbackCategories[0],
    applications: [fallbackApplications[2]],
    description: 'Vải không dệt cường độ rất cao 50 kN/m, dùng cho gia cố nền nặng, đường cao tốc, sân bay, bãi chứa container. Đạt TCVN 9844:2013, ISO 9001:2015.',
    specs: [
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '50 kN/m' },
      { icon: 'water_drop', label: 'Hệ số thấm', value: '≥ 8.0 × 10⁻⁴ m/s' },
    ],
  },
  {
    slug: 'vai-kt-khong-det-art-60',
    code: 'ART 60',
    name: 'Vải địa kỹ thuật không dệt 60 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '60 kN/m',
    strength_min: '60.00',
    strength_max: '60.00',
    category: fallbackCategories[0],
    applications: [fallbackApplications[2]],
    description: 'Vải không dệt cường độ rất cao 60 kN/m, dùng cho gia cố nền rất nặng, đường cao tốc, đường sắt. Đạt TCVN 9844:2013, ISO 9001:2015.',
    specs: [
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '60 kN/m' },
      { icon: 'water_drop', label: 'Hệ số thấm', value: '≥ 8.0 × 10⁻⁴ m/s' },
    ],
  },
  {
    slug: 'vai-kt-khong-det-art-70',
    code: 'ART 70',
    name: 'Vải địa kỹ thuật không dệt 70 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '70 kN/m',
    strength_min: '70.00',
    strength_max: '70.00',
    category: fallbackCategories[0],
    applications: [fallbackApplications[2]],
    description: 'Vải không dệt cường độ rất cao 70 kN/m, dùng cho gia cố nền rất nặng, đường cao tốc, đường sắt. Đạt TCVN 9844:2013, ISO 9001:2015.',
    specs: [
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '70 kN/m' },
      { icon: 'water_drop', label: 'Hệ số thấm', value: '≥ 8.0 × 10⁻⁴ m/s' },
    ],
  },
  {
  ...
  {
    slug: 'vai-kt-khong-det-art-110',
    code: 'ART 110',
    name: 'Vải địa kỹ thuật không dệt 110 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '110 kN/m',
    strength_min: '110.00',
    strength_max: '110.00',
    category: fallbackCategories[0],
    applications: [fallbackApplications[2]],
    description: 'Vải không dệt cường độ đặc biệt nặng 110 kN/m, dùng cho gia cố nền đặc biệt nặng, kè biển, đê điều. Đạt TCVN 9844:2013, ISO 9001:2015.',
    specs: [
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '110 kN/m' },
      { icon: 'water_drop', label: 'Hệ số thấm', value: '≥ 5.0 × 10⁻⁴ m/s' },
    ],
  },
  {
    slug: 'vai-kt-khong-det-art-140',
    code: 'ART 140',
    name: 'Vải địa kỹ thuật không dệt 140 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '140 kN/m',
    strength_min: '140.00',
    strength_max: '140.00',
    category: fallbackCategories[0],
    applications: [fallbackApplications[2]],
    description: 'Vải không dệt cường độ đặc biệt nặng 140 kN/m, dùng cho gia cố nền đặc biệt nặng, kè biển, đê điều. Đạt TCVN 9844:2013, ISO 9001:2015.',
    specs: [
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '140 kN/m' },
      { icon: 'water_drop', label: 'Hệ số thấm', value: '≥ 5.0 × 10⁻⁴ m/s' },
    ],
  },
  {
    slug: 'vai-kt-khong-det-art-200',
    code: 'ART 200',
    name: 'Vải địa kỹ thuật không dệt 200 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '200 kN/m',
    strength_min: '200.00',
    strength_max: '200.00',
    category: fallbackCategories[0],
    applications: [fallbackApplications[2]],
    description: 'Vải không dệt cường độ cực lớn 200 kN/m, dùng cho gia cố nền cực lớn, dự án hạ tầng trọng điểm quốc gia. Đạt TCVN 9844:2013, ISO 9001:2015.',
    specs: [
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '200 kN/m' },
      { icon: 'water_drop', label: 'Hệ số thấm', value: '≥ 3.0 × 10⁻⁴ m/s' },
    ],
  },
  {
    slug: 'vai-kt-khong-det-art-280',
    code: 'ART 280',
    name: 'Vải địa kỹ thuật không dệt 280 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '280 kN/m',
    strength_min: '280.00',
    strength_max: '280.00',
    category: fallbackCategories[0],
    applications: [fallbackApplications[2]],
    description: 'Vải không dệt cường độ cực lớn 280 kN/m, dùng cho gia cố nền cực lớn, dự án hạ tầng trọng điểm quốc gia. Đạt TCVN 9844:2013, ISO 9001:2015.',
    specs: [
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '280 kN/m' },
      { icon: 'water_drop', label: 'Hệ số thấm', value: '≥ 3.0 × 10⁻⁴ m/s' },
    ],
  },
  {
    slug: 'vai-kt-det-get-5',
    code: 'GET 5',
    name: 'Vải địa kỹ thuật dệt 5 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '5 kN/m',
    strength_min: '5.00',
    strength_max: '5.00',
    category: fallbackCategories[1],
    applications: [fallbackApplications[0]],
    description: 'Vải địa kỹ thuật dệt từ sợi polypropylene (PP), cường độ 5 kN/m, dùng cho gia cố nền nhẹ, phân cách. Đạt TCVN 9844:2013.',
    specs: [
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '5 kN/m' },
    ],
  },
  {
    slug: 'vai-kt-det-get-10',
    code: 'GET 10',
    name: 'Vải địa kỹ thuật dệt 10 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '10 kN/m',
    strength_min: '10.00',
    strength_max: '10.00',
    category: fallbackCategories[1],
    applications: [fallbackApplications[0], fallbackApplications[2]],
    description: 'Vải địa kỹ thuật dệt từ sợi PP, cường độ 10 kN/m, dùng cho phân cách, gia cố nền. Đạt TCVN 9844:2013.',
    specs: [
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '10 kN/m' },
    ],
  },
  {
    slug: 'vai-kt-det-get-15',
    code: 'GET 15',
    name: 'Vải địa kỹ thuật dệt 15 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '15 kN/m',
    strength_min: '15.00',
    strength_max: '15.00',
    category: fallbackCategories[1],
    applications: [fallbackApplications[0], fallbackApplications[2]],
    description: 'Vải địa kỹ thuật dệt từ sợi PP, cường độ 15 kN/m, dùng cho phân cách, gia cố nền. Đạt TCVN 9844:2013.',
    specs: [
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '15 kN/m' },
    ],
  },
  {
  ...
  {
    slug: 'vai-kt-det-get-30',
    code: 'GET 30',
    name: 'Vải địa kỹ thuật dệt 30 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '30 kN/m',
    strength_min: '30.00',
    strength_max: '30.00',
    category: fallbackCategories[1],
    applications: [fallbackApplications[0], fallbackApplications[2], fallbackApplications[4]],
    description: 'Vải địa kỹ thuật dệt từ sợi PP, cường độ 30 kN/m, dùng cho gia cố nền, mái dốc. Đạt TCVN 9844:2013.',
    specs: [
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '30 kN/m' },
    ],
  },
  {
    slug: 'vai-kt-det-get-50',
    code: 'GET 50',
    name: 'Vải địa kỹ thuật dệt 50 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '50 kN/m',
    strength_min: '50.00',
    strength_max: '50.00',
    ...
    description: 'Vải địa kỹ thuật dệt từ sợi PP, cường độ 50 kN/m, dùng cho gia cố nền nặng, mái dốc. Đạt TCVN 9844:2013.',
    specs: [
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '50 kN/m' },
    ],
  },
  {
    slug: 'vai-kt-det-get-80',
    code: 'GET 80',
    name: 'Vải địa kỹ thuật dệt 80 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '80 kN/m',
    strength_min: '80.00',
    strength_max: '80.00',
    category: fallbackCategories[1],
    applications: [fallbackApplications[2], fallbackApplications[4]],
    description: 'Vải địa kỹ thuật dệt từ sợi PP, cường độ 80 kN/m, dùng cho gia cố nền nặng, mái dốc, tường chắn. Đạt TCVN 9844:2013.',
    specs: [
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '80 kN/m' },
    ],
  },
  {
  ...
  {
    slug: 'vai-kt-det-get-150',
    code: 'GET 150',
    name: 'Vải địa kỹ thuật dệt 150 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '150 kN/m',
    strength_min: '150.00',
    strength_max: '150.00',
    category: fallbackCategories[1],
    applications: [fallbackApplications[2], fallbackApplications[4]],
    description: 'Vải dệt cường độ rất cao 150 kN/m, dùng cho gia cố nền rất nặng, mái dốc cao. Đạt TCVN 9844:2013.',
    specs: [
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '150 kN/m' },
    ],
  },
  {
    slug: 'vai-kt-det-get-200',
    code: 'GET 200',
    name: 'Vải địa kỹ thuật dệt 200 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '200 kN/m',
    strength_min: '200.00',
    strength_max: '200.00',
    category: fallbackCategories[1],
    applications: [fallbackApplications[2], fallbackApplications[4]],
    description: 'Vải dệt cường độ đặc biệt 200 kN/m, dùng cho gia cố nền đặc biệt, dự án hạ tầng trọng điểm. Đạt TCVN 9844:2013.',
    specs: [
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '200 kN/m' },
    ],
  },
  {
    slug: 'vai-kt-det-get-300',
    code: 'GET 300',
    name: 'Vải địa kỹ thuật dệt 300 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '300 kN/m',
    strength_min: '300.00',
    strength_max: '300.00',
    category: fallbackCategories[1],
    applications: [fallbackApplications[2], fallbackApplications[4]],
    description: 'Vải dệt cường độ đặc biệt 300 kN/m, dùng cho gia cố nền đặc biệt, kè biển, đê điều. Đạt TCVN 9844:2013.',
    specs: [
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '300 kN/m' },
    ],
  },
  {
    slug: 'vai-kt-det-get-500',
    code: 'GET 500',
    name: 'Vải địa kỹ thuật dệt 500 kN/m',
    image: img('geotextile-roll.jpg'),
    strength_label: '500 kN/m',
    strength_min: '500.00',
    strength_max: '500.00',
    category: fallbackCategories[1],
    applications: [fallbackApplications[2], fallbackApplications[4]],
    description: 'Vải dệt cường độ cực lớn 500 kN/m, dùng cho gia cố nền cực lớn, dự án hạ tầng trọng điểm quốc gia. Đạt TCVN 9844:2013.',
    specs: [
      { icon: 'compress', label: 'Cường độ chịu kéo', value: '500 kN/m' },
    ],
  },
  {
...
export const fallbackTimeline: AboutTimeline[] = [
  ...
  { year: '2017 - Nhà máy Lưới thép Tiên Phong', description: 'Khánh thành nhà máy Lưới thép Tiên Phong tại Đà Nẵng, công suất 5.000 tấn/năm. Tổng công suất 2 nhà máy đạt 8.000 tấn/năm.' },
  { year: '2023 - Đối tác HOCK Technology', description: 'Trở thành nhà phân phối uỷ quyền chính thức dòng sản phẩm vải địa kỹ thuật ARITEX của HOCK Technology tại Việt Nam (Giấy uỷ quyền số CTCO-AT-VN04-20220905-01, cấp 30/10/2023).' },
